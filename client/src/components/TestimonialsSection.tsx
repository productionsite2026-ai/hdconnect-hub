...
const TestimonialsSection = () => (
  <section className="py-12 sm:py-16 md:py-20 relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 relative">
      ...
      {/* Stats bar */}
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex flex-wrap justify-center gap-4 sm:gap-5 md:gap-6 mb-12">
        {[
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
        {testimonials.map((t, i) => (
          <motion.div
            ...
            whileHover={{ y: -4 }}
            className="bg-card rounded-xl p-6 card-shadow border border-border hover:card-shadow-hover transition-all"
          >
