      ...
      <section className="py-16">
        <div className="container mx-auto px-4 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="prose prose-invert max-w-none">
            ...
            <p className="text-muted-foreground mb-4">
              Ce site est hébergé par un prestataire de services d'hébergement web professionnel.
            </p>
            ...
            <p className="text-muted-foreground mb-4">
              Répar'Action Volets est certifiée RGE (Reconnu Garant de l'Environnement) et Qualibat. Nos interventions bénéficient d'une garantie décennale.
            </p>
          </motion.div>
