        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <p className="text-muted-foreground mb-4 leading-relaxed">
              Répar'Action Volets collecte vos données personnelles uniquement lorsque vous nous contactez via notre formulaire de devis ou par téléphone. Les données collectées incluent votre nom, prénom, adresse email, numéro de téléphone et adresse postale.
            </p>
