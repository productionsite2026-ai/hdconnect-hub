...
const ReparationVoletManteslaJolie = () => {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Réparation Volet Roulant Mantes-la-Jolie (78) | Expert 7j/7 | Répar'Action Volets";
  }, []);
  ...
  return (
    <main>
        ...
        <div className="container mx-auto px-4">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="max-w-4xl">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-extrabold leading-tight mb-6">
              Réparation de Volets Roulants à Mantes-la-Jolie : Votre Expert Local
            </h1>
            <p className="text-lg text-primary-foreground/80 mb-8 leading-relaxed">
              Ville importante de l'ouest francilien Répar'Action Volets est votre spécialiste de confiance pour tous vos besoins en réparation, installation et motorisation de volets roulants. Intervention rapide sous 48h, devis gratuit, et garantie 3 ans.
            </p>
      ...
      <section className="py-12 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto p-8 bg-background rounded-lg border border-border">
            <h2 className="font-semibold text-foreground mb-4">Réparation Volets Roulants Mantes-la-Jolie (78) - Réponse Rapide</h2>
            <p className="text-foreground leading-relaxed mb-4">
              Pour la réparation de volets roulants à Mantes-la-Jolie, Répar'Action Volets intervient en 48h maximum, propose un devis gratuit et sans engagement, et garantit ses interventions 3 ans. Nos techniciens certifiés RGE et Qualibat sont disponibles 7j/7. Zone d'intervention : Mantes-la-Jolie et ses environs.
            </p>
            <p className="text-foreground leading-relaxed">
              Nous proposons une expertise complète en réparation, installation, remplacement et motorisation de volets roulants adaptée à Mantes-la-Jolie. Marques partenaires : Somfy, Bubendorff, Profalux.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-3xl font-bold text-foreground mb-8">À Propos de Mantes-la-Jolie</h2>
            
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="p-6 rounded-lg border border-border">
                <Users className="h-8 w-8 text-accent mb-3" />
                <h3 className="font-semibold text-foreground mb-2">Population</h3>
                <p className="text-2xl font-bold text-accent">43 300</p>
              </div>
              <div className="p-6 rounded-lg border border-border">
              ...
              <div className="p-6 rounded-lg border border-border">
                ...
                <p className="text-sm text-muted-foreground">Ville importante de l'ouest francilien</p>
              </div>
            </div>

            <div className="bg-muted/30 p-8 rounded-lg mb-12">
              <h3 className="font-semibold text-foreground mb-4">À Propos de Mantes-la-Jolie</h3>
              <p className="text-foreground leading-relaxed mb-4">
                Mantes-la-Jolie est une commune importante du Yvelines (78), ville importante de l'ouest francilien. Avec une population de 43 300 habitants, Mantes-la-Jolie est une ville dynamique avec une vie de quartier active.
              </p>
              <p className="text-foreground leading-relaxed">
                Répar'Action Volets intervient régulièrement à Mantes-la-Jolie pour répondre aux besoins en réparation, installation et motorisation de volets roulants de ses habitants et entreprises.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-3xl font-bold text-foreground mb-8">Services Spécialisés pour Mantes-la-Jolie</h2>
              ...
              <div className="p-6 rounded-lg border border-border bg-background">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Volet bloqué, moteur défaillant, problème de sécurité ? Intervention d'urgence 7j/7 à Mantes-la-Jolie. Délai : généralement moins de 24h.</p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-3xl font-bold text-foreground mb-8">Pourquoi Choisir Répar'Action Volets pour Mantes-la-Jolie ?</h2>
            
            <div className="grid md:grid-cols-2 gap-6">
              <div className="p-6 rounded-lg border border-border">
                <h3 className="font-semibold text-foreground mb-3">✓ Expertise Locale</h3>
                <p className="text-sm text-muted-foreground">Nos techniciens connaissent parfaitement Mantes-la-Jolie et ses spécificités.</p>
              </div>
              <div className="p-6 rounded-lg border border-border">
                <h3 className="font-semibold text-foreground mb-3">✓ Intervention Rapide</h3>
                <p className="text-sm text-muted-foreground">Délai moyen de 24-48h pour une intervention à Mantes-la-Jolie. Urgences 7j/7.</p>
              </div>
              <div className="p-6 rounded-lg border border-border">
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-3xl font-bold text-foreground mb-8">Témoignages de Clients de Mantes-la-Jolie</h2>
              ...
              <div className="p-6 rounded-lg border border-border bg-background">
                <div className="flex items-start gap-4 mb-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Mantes-la-Jolie</p>
                  </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-3xl font-bold text-foreground mb-8">Questions Fréquentes - Réparation Volets Mantes-la-Jolie</h2>
            
            <div className="space-y-6">
              <div className="p-6 rounded-lg border border-border">
                <h3 className="font-semibold text-foreground mb-3">Quel est le délai d'intervention à Mantes-la-Jolie ?</h3>
                <p className="text-foreground leading-relaxed">
                  Nous intervenons généralement sous 24-48h à Mantes-la-Jolie. Pour les urgences, contactez-nous au 06 03 20 59 67 et nous nous efforçons d'intervenir le jour même ou le lendemain.
                </p>
              </div>
              ...
              <div className="p-6 rounded-lg border border-border">
                ...
                <p className="text-foreground leading-relaxed">
                  Oui, nos techniciens sont disponibles 7j/7 pour les urgences à Mantes-la-Jolie. Nous proposons des interventions le dimanche et les jours fériés.
                </p>
              </div>
              ...
              <div className="p-6 rounded-lg border border-border">
                <h3 className="font-semibold text-foreground mb-3">Quel est le coût moyen d'une réparation à Mantes-la-Jolie ?</h3>
                <p className="text-foreground leading-relaxed">
      ...
      <section className="py-16 bg-accent">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-display text-3xl font-bold text-accent-foreground mb-6">
            Besoin d'une Réparation à Mantes-la-Jolie ?
          </h2>
...
export default ReparationVoletManteslaJolie;
